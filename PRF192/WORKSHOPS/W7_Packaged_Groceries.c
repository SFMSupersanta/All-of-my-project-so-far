...
////////////////////////////////////////////////////////////////
Design and code a program that lists the inventory in a packaged 
goods grocery store in barcode order.  Your program prompts for 
and accepts
...
validate the input and to sort the items by barcode.  You may 
assume that there are no more than 100 items to process, but 
