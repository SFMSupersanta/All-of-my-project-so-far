...
##############################################
////////////////////////////////////////////////////////////////
Design and code a program that lists the work in progress in a 
consulting company in project order.  Your program prompts for 
and accepts
...
validate the input and to sort the project information by 
project number.  You may assume that there are no more than 100 
projects to process, but write your code so that you can change 
this limit by editing a single statement.

Preface each function header with a comprehensive description of 
