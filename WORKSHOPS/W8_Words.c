...
###################
////////////////////////////////////////////////////////////////
Design and code a function named wordCount that receives a null terminated string of text and returns the number of words contained in the string.  Consider a word to be any sequence of non-whitespace characters.

The whitespace characters include newline, horizontal tab, form feed, vertical tab and space characters. 

Finally, write a program that accepts a string to be counted and displays the number of words in the string.  You may assume that the user will not input a string that contains more than 100 characters, but may input an empty string.
